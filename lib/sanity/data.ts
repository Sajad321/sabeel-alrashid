...
const PAGE_QUERY = defineQuery(
  `*[_id == $id][0]{title,hero{eyebrow,title,description,"image":{"src":image.asset->url,"alt":image.alt}},seo{title,description,"image":image.asset->url,noIndex},introduction{heading,body,"image":{"src":image.asset->url,"alt":image.alt}},statistics[]{value,label},historyHeading,timeline[]{year,title,description},vision{heading,body,"image":{"src":image.asset->url,"alt":image.alt}},mission{heading,body,"image":{"src":image.asset->url,"alt":image.alt}},teamHeading,featuresHeading,features[]{icon,title,description},formHeading,formDescription,culture{heading,body,"image":{"src":image.asset->url,"alt":image.alt}},cultureValues,benefitsHeading,benefits[]{icon,title,description},positionsHeading,callToAction{heading,body,"image":{"src":image.asset->url,"alt":image.alt}},callToActionLabel}`,
);
